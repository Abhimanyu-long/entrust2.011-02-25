...
export const AddNewProject = () => {
  ...
  const [variable1RateCaption, setVariable1RateCaption] =
    useState("Variable 1 Count");
  const [variable2RateCaption, setVariable2RateCaption] =
    useState("Variable 2 Count");
  const [variable3RateCaption, setVariable3RateCaption] =
    useState("Variable 3 Count");
  const [variable4RateCaption, setVariable4RateCaption] =
    useState("Variable 4 Count");
  const [variable5RateCaption, setVariable5RateCaption] =
    useState("Variable 5 Count");
  const [variable6RateCaption, setVariable6RateCaption] =
    useState("Variable 6 Count");
  const [variable7RateCaption, setVariable7RateCaption] =
    useState("Variable 7 Rate");

  const [fixedCountCaption, setFixedCountCaption] = useState("Fixed Count");
  const [variable1CountCaption, setVariable1CountCaption] =
    useState("Variable 1 Count");
  const [variable2CountCaption, setVariable2CountCaption] =
    useState("Variable 2 Count");
  const [variable3CountCaption, setVariable3CountCaption] =
    useState("Variable 3 Count");
  const [variable4CountCaption, setVariable4CountCaption] =
    useState("Variable 4 Count");
  const [variable5CountCaption, setVariable5CountCaption] =
    useState("Variable 5 Count");
  const [variable6CountCaption, setVariable6CountCaption] =
    useState("Variable 6 Count");
  const [variable7CountCaption, setVariable7CountCaption] =
    useState("Variable 7 Count");
  ...
  const handleSave = async () => {
    ...
    const DATA = encryptJson(data, VITE_SECRET_KEY);
    try {
  ...
  const projectreferralRef = useRef(null);
  const billablestatementRef = useRef(null);
  const estimateunitRef = useRef(null);
  const Time_Estimate_ApprovalsetupRef = useRef(null);
  const Project_Wise_Invoice_Configuration = useRef(null);
  const MRR_Setting = useRef(null);
  const ESignatureSetting = useRef(null);
  const CaseSetting = useRef(null);
  const CommentSetting = useRef(null);
  const ChecklistSetting = useRef(null);
  const ProjectSetting = useRef(null);
  const MRSIntegrationSetting = useRef(null)
  const Review_Sheet_Integration_Settings = useRef(null)
        ...
        <Card className="p-4 shadow-lg border-0">
          <Row>
            <Col lg={9} md={8} style={{ height: "100vh", overflowY: "scroll" }}>
              ...
              <div className="m-2">
                <Card className="p-4 shadow-lg border-0">
                  <Accordion defaultActiveKey="1" className="card card-flush accordionCard" id="section-title">
                    {/* Project Settings */}
                  ...
                  <Accordion defaultActiveKey="1" id="section-body" className="card card-flush accordionCard">
                    {/* Project Settings */}
                    <Accordion.Item eventKey="1">
                      <Accordion.Header>
                  ...
                  <Accordion defaultActiveKey="0"
                    id="section-project-referral" className="card card-flush accordionCard">
                    {/* Referral Invoice */}
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-define-billable-statement">
                    <Accordion.Item eventKey="1">
                      <Accordion.Header>
                      ...
                      <Accordion.Body className="bg-light">
                        <div className="billable-statement form-check-custom mb-4">
                          ...
                          />
                          <label htmlFor="all" className="mx-2">All</label>
                        </div>
                        <div>
                          <input
                            className="form-check-input p-2 fs-8"
                            ...
                            onChange={(e) => setBillStatementFor(e.target.value)}
                          />
                          <label htmlFor="delivered" className="mx-2">Delivered Only</label>
                        </div>
                      </Accordion.Body>
                    </Accordion.Item>
                  </Accordion>

                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-estimate-unit">
                    {/* Estimate Unit */}
                    <Accordion.Item eventKey="2">
                      ...
                      <Accordion.Body className="bg-light">
                        ...
                        <div className="form-check form-check-custom form-check-solid form-check-sm">
                          ...
                          />
                          <label htmlFor="splitEstimate" className="fs-8">&nbsp; Split Estimate</label>
                        </div>
                      </Accordion.Body>
                    </Accordion.Item>
                  </Accordion>

                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-time-estimate-approval-setup">
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-project-wise-invoice-configuration">
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-mrr-setting">
                    {/* MRR Setting */}
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-e-signature-setting">
                    {/* E-Signature Setting */}
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-case-setting">
                    {/* Case Setting */}
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-comment-setting">
                    {/* Comment Settings */}
                  ...
                  <Accordion defaultActiveKey="0" className="card card-flush accordionCard" id="section-checklist-setting">
                    {/* Checklist Settings */}
...

{
  /* <div className="form-group">
              ...
              >
                <option value="Resource Based">Resource Based</option>
                <option value="Time Based">Case</option>
                <option value="Resource Based">Case Plus Variable</option>
                <option value="Resource Based">SAAS Based</option>
                <option value="Resource Based">MRR Based</option>
              </select>
